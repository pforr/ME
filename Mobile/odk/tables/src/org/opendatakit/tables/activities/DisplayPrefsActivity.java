...
public class DisplayPrefsActivity extends PreferenceActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		appName = IntentUtil.retrieveAppNameFromBundle(this.getIntent()
				.getExtras());
		if (appName == null) {
			throw new IllegalStateException(
					"App name not passed to activitity.");
		}
	...
	private void generalPreferences() {
		...
		// fontSizePref.setOnPreferenceChangeListener(new
		...
		useHomescreenPref.setChecked(true);
		File homeScreen = new File(
				ODKFileUtils.getTablesHomeScreenFile(appName));
				...
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						OutputUtil.writeControlObject(
								...
								DisplayPrefsActivity.this.appName);
		...
		aboutPref
				.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
					...
					@Override
					public boolean onPreferenceClick(Preference preference) {
						Intent i = new Intent(DisplayPrefsActivity.this,
								AboutWrapperActivity.class);
	...
	// set a custom font size for this table that overrides the general font
	// size
	private void customPreferences() {
		...
		PreferenceCategory genCat = new PreferenceCategory(this);
		root.addPreference(genCat);
		genCat.setTitle(getString(R.string.display_prefs_for,
				localizedDisplayName));

		// final SliderPreference fontSizePref = new SliderPreference(this,
		// prefs.getFontSize());
