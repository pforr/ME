...
<aui:form action="<%= addBenVungURL %>" method="post" name="fm">
	...
	<aui:input name="loaiHinh" type="hidden" value="<%= Validator.isNotNull(selTramCap) ? selTramCap.getMaMoHinh() : StringPool.BLANK %>"></aui:input>
	<aui:input name="dauNoiThietKe" type="hidden" value="<%= Validator.isNotNull(selTramCap) ? selTramCap.getTongDauNoiThietKe() : Integer.toString(0) %>"></aui:input>
	<aui:input name="boMayVanHanh" type="hidden" value="<%= Validator.isNotNull(selTramCap) ? selTramCap.getBoMayVanHanh() : Integer.toString(0) %>"></aui:input>
