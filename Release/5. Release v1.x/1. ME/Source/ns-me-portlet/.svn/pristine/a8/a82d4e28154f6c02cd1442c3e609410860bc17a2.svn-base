...
public class KeHoachVeSinhFinderUtil {
	public static int countVSGD(java.lang.String maTinh,
		...
		return getFinder()
				   .countVSGD(maTinh, maHuyen, maXa, loaiNhaTieuId, trangThai,
			namBaoCao, namBaoCaoVstx, ngayNhap, idNguoiTao, advText);
	}

	public static java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhGiaDinh> finderVSGD(
		...
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getFinder()
				   .finderVSGD(maTinh, maHuyen, maXa, loaiNhaTieuId, trangThai,
			namBaoCao, namBaoCaoVstx, ngayNhap, idNguoiTao, advText, start, end);
	}
