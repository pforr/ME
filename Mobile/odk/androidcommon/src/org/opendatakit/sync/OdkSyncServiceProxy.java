...
public class OdkSyncServiceProxy implements ServiceConnection {
  ...
  public boolean synchronizeFromServer(String appName, boolean deferInstanceAttachments,String tableID) throws RemoteException {
    if (appName == null)
      throw new IllegalArgumentException("App Name cannot be null");

    try {
      return sensorSvcProxy.synchronize(appName, deferInstanceAttachments,tableID);
    } catch (RemoteException rex) {
      rex.printStackTrace();
      throw rex;
    }
