...
public class MAUKIEMDEMModelImpl extends BaseModelImpl<MAUKIEMDEM>
	...
	public Object clone() {
		...
		maukiemdemImpl.setMauRaSoat(getMauRaSoat());
	...
	public CacheModel<MAUKIEMDEM> toCacheModel() {
		...
		maukiemdemCacheModel.mauRaSoat = getMauRaSoat();
