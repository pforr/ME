	...
	public void initDanhGiaVeSinh(String maTinh, String maHuyen, int nam,
		...
		if (count == 0 && Validator.isNotNull(maHuyen)) {
			...
			for (DanhGiaVeSinhXaNewFake ettFake : listInsert) {
				...
				try {
					countHGDCoNhaTieuXayMoi = danhGiaVeSinhXaNewFakeFinder.countHoGiaDinhCoNhaTieu(ettFake.getMaXa(), nam);
					countHGDCoNhaTieu = danhGiaVeSinhXaNewFakeFinder.countHoGiaDinhCoNhaTieu(ettFake.getMaXa(), nam);
					countHGDCoNhaTieuHVS = danhGiaVeSinhXaNewFakeFinder.countHoGiaDinhCoNhaTieuHVS(ettFake.getMaXa(), nam);
				} catch (Exception e) {
