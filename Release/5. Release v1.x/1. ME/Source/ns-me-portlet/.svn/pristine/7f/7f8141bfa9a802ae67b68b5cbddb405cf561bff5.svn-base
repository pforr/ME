...
<aui:select cssClass="input1001" name="<%=KeHoachKiemDemVeSinhTerms.KIEM_DEM_VIEN_ID %>" id="<%=KeHoachKiemDemVeSinhTerms.KIEM_DEM_VIEN_ID %>"  label="<%= LanguageUtil.get(pageContext, \"kiem-dem-vien\") + dotLabel %>" showEmptyOption="<%= false %>">
