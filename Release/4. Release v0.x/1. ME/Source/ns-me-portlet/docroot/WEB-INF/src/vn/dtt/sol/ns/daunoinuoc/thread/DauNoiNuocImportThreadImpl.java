...
//						dataItem = DataItemBusiness.getDATAITEMByTen(dauNoiNuocImportModel.getTinh(),"");
...
//						dataItem = DataItemBusiness.getDATAITEMByTen(dauNoiNuocImportModel.getHuyen(),dauNoiNuocImportModel.getMaTinh());
...
//						dataItem = DataItemBusiness.getDATAITEMByTen(dauNoiNuocImportModel.getXa(),dauNoiNuocImportModel.getMaHuyen());
						...
						ettImport.setSoNguoiTrongHo(!dauNoiNuocImportModel.getSoNguoiTrongHo().isEmpty()?Integer.valueOf(dauNoiNuocImportModel.getSoNguoiTrongHo()):0);
