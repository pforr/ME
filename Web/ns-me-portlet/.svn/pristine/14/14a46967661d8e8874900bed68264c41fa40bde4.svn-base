...
public class VeSinhGiaDinhTerms {
	...
	public static final String GIAM_SAT_VIEN = "giamSatVien";
	...
	public VeSinhGiaDinhTerms(ActionRequest actionRequest )
	{
		...
		kiemDemVien = ParamUtil.getString(request,KIEM_DEM_VIEN);
		giamSatVien = ParamUtil.getString(request,GIAM_SAT_VIEN);
