 ...
 * @generated
 */
public abstract class ChiTietKiemDemCongTrinhActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public ChiTietKiemDemCongTrinhActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(ChiTietKiemDemCongTrinhLocalServiceUtil.getService());
		setClass(ChiTietKiemDemCongTrinh.class);
