 ...
 * @generated
 */
public class DATAGROUPLocalServiceClp implements DATAGROUPLocalService {
	public DATAGROUPLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.dtt.cmon.dm.dao.model.DATAGROUP addDATAGROUP(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(datagroup) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.cmon.dm.dao.model.DATAGROUP)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.dm.dao.model.DATAGROUP> getDATAGROUPs(
		...
		return (java.util.List<vn.dtt.cmon.dm.dao.model.DATAGROUP>)ClpSerializer.translateOutput(returnObj);
	}
