...
<liferay-ui:header
	backURL="<%= redirectURL %>"
	title='<%= Validator.isNotNull(userMapping) ? "edit-user-mapping-cap-tinh" : "add-user-mapping-cap-tinh" %>'
/>
...
<portlet:actionURL var="formAction" name="addUserTinh" />
...
<aui:form action="<%= formAction %>" method="post" name="fm">
	...
	<aui:input name="userType" type="hidden" value="2"/>
	...
	<div class="add-user-tramcap-wrapper">
		<liferay-ui:form-navigator
			...
			jspPath="/html/portlet/usermapping/usertinh/"
		/>
	</div>
</aui:form>