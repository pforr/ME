...
public class BaoCaoDLIModelImpl extends BaseModelImpl<BaoCaoDLI>
	...
	public static final Object[][] TABLE_COLUMNS = {
			...
			{ "keHoachNam", Types.VARCHAR },
			{ "ngayPheDuyet", Types.TIMESTAMP },
			{ "baoCaoChuongTrinh", Types.VARCHAR },
			{ "ngayDang", Types.TIMESTAMP }
		};
	public static final String TABLE_SQL_CREATE = "create table ME_BAOCAODLI (ID LONG not null primary key,MATINH VARCHAR(75) null,NAM INTEGER,LOAIBAOCAO INTEGER,NGUOILAP VARCHAR(75) null,NGUOIDUYET VARCHAR(75) null,SOBAOCAO VARCHAR(75) null,NGAYBAOCAO DATE null,TRANGTHAI INTEGER,LUUTRUPDF_1 LONG,LUUTRUPDF_2 LONG,LUUTRUCSV_1 LONG,LUUTRUCSV_2 LONG,keHoachNam VARCHAR(75) null,ngayPheDuyet DATE null,baoCaoChuongTrinh VARCHAR(75) null,ngayDang DATE null)";
	...
	public static BaoCaoDLI toModel(BaoCaoDLISoap soapModel) {
		...
		model.setKeHoachNam(soapModel.getKeHoachNam());
		model.setNgayPheDuyet(soapModel.getNgayPheDuyet());
	...
	public Object clone() {
		...
		baoCaoDLIImpl.setKeHoachNam(getKeHoachNam());
		baoCaoDLIImpl.setNgayPheDuyet(getNgayPheDuyet());
		baoCaoDLIImpl.setBaoCaoChuongTrinh(getBaoCaoChuongTrinh());
		baoCaoDLIImpl.setNgayDang(getNgayDang());
	...
	public CacheModel<BaoCaoDLI> toCacheModel() {
		...
		baoCaoDLICacheModel.keHoachNam = getKeHoachNam();

		String keHoachNam = baoCaoDLICacheModel.keHoachNam;

		if ((keHoachNam != null) && (keHoachNam.length() == 0)) {
			baoCaoDLICacheModel.keHoachNam = null;
		}

		Date ngayPheDuyet = getNgayPheDuyet();

		if (ngayPheDuyet != null) {
			baoCaoDLICacheModel.ngayPheDuyet = ngayPheDuyet.getTime();
		}
		else {
			baoCaoDLICacheModel.ngayPheDuyet = Long.MIN_VALUE;
		}

		baoCaoDLICacheModel.baoCaoChuongTrinh = getBaoCaoChuongTrinh();

		String baoCaoChuongTrinh = baoCaoDLICacheModel.baoCaoChuongTrinh;

		if ((baoCaoChuongTrinh != null) && (baoCaoChuongTrinh.length() == 0)) {
			baoCaoDLICacheModel.baoCaoChuongTrinh = null;
		}

		Date ngayDang = getNgayDang();

		if (ngayDang != null) {
			baoCaoDLICacheModel.ngayDang = ngayDang.getTime();
		}
		else {
			baoCaoDLICacheModel.ngayDang = Long.MIN_VALUE;
		}
