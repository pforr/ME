...
/**
 * Provides the local service interface for keHoachVeSinhXaNew. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author BinhTH
 * @see keHoachVeSinhXaNewLocalServiceUtil
...
public interface keHoachVeSinhXaNewLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link keHoachVeSinhXaNewLocalServiceUtil} to access the ke hoach ve sinh xa new local service. Add custom service methods to {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.impl.keHoachVeSinhXaNewLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
