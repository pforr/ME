...
<aui:form action="<%= searchURL %>" method="get" name="fm2">
	...
	<aui:fieldset>
		<liferay-ui:search-container delta="<%= DEFAULT_DELTA %>" emptyResultsMessage="no-result-were-found">
			...
			<liferay-ui:search-container-results results="<%=  TramCapBusiness.findTramCap(user, maTinh, keyword, searchContainer.getStart(), searchContainer.getEnd()) %>"
								 total="<%= TramCapBusiness.countTramCap(user, maTinh, keyword) %>">
