...
/**
 * The persistence utility for the d m_ t h o n x o m service. This utility wraps {@link DM_THONXOMPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see DM_THONXOMPersistenceImpl
 * @generated
 */
public class DM_THONXOMUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(DM_THONXOM dm_thonxom) {
		getPersistence().clearCache(dm_thonxom);
	}
	 ...
	 */
	public static List<DM_THONXOM> findWithDynamicQuery(
	 ...
	 */
	public static DM_THONXOM update(DM_THONXOM dm_thonxom)
		throws SystemException {
		return getPersistence().update(dm_thonxom);
	}
	...
	public static DM_THONXOM update(DM_THONXOM dm_thonxom,
		...
		return getPersistence().update(dm_thonxom, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(dm_thonxom);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<vn.dtt.cmon.dm.dao.model.DM_THONXOM> dm_thonxoms) {
		getPersistence().cacheResult(dm_thonxoms);
	}
	...
	*/
	public static vn.dtt.cmon.dm.dao.model.DM_THONXOM create(long id) {
	...
	*/
	public static vn.dtt.cmon.dm.dao.model.DM_THONXOM remove(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.cmon.dm.dao.NoSuchDM_THONXOMException {
		return getPersistence().remove(id);
	}

	public static vn.dtt.cmon.dm.dao.model.DM_THONXOM updateImpl(
		vn.dtt.cmon.dm.dao.model.DM_THONXOM dm_thonxom)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(dm_thonxom);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.cmon.dm.dao.model.DM_THONXOM findByPrimaryKey(long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.cmon.dm.dao.NoSuchDM_THONXOMException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.cmon.dm.dao.model.DM_THONXOM fetchByPrimaryKey(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.cmon.dm.dao.model.DM_THONXOM> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static DM_THONXOMPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (DM_THONXOMPersistence)PortletBeanLocatorUtil.locate(vn.dtt.cmon.dm.dao.service.ClpSerializer.getServletContextName(),
					DM_THONXOMPersistence.class.getName());

			ReferenceRegistry.registerReference(DM_THONXOMUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(DM_THONXOMPersistence persistence) {
	}

	private static DM_THONXOMPersistence _persistence;
}