...
<aui:select cssClass="input1001" required="true" name="<%=KeHoachKiemDemNuocTerms.KIEM_DEM_VIEN_ID %>" id="tramCapIdAjax"  label="<%= LanguageUtil.get(pageContext, \"kiem-dem-vien\") + dotLabel %>" showEmptyOption="<%= false %>">
