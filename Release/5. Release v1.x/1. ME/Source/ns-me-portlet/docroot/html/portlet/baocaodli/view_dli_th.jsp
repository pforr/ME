			...
			<aui:fieldset>
				<liferay-ui:search-container delta="20" emptyResultsMessage="no-result-were-found" 
					...
					<liferay-ui:search-container-results
						results="<%= BaoCaoDLIBusiness.searchDLITH(userType, Integer.toString(2015) , maTinh, searchContainer.getStart(), searchContainer.getEnd()) %>"
						total="<%= BaoCaoDLIBusiness.searchDLITH(userType, Integer.toString(2015) , maTinh, searchContainer.getStart(), searchContainer.getEnd()).size() %>"
					/>
