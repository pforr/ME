...
package vn.dtt.cmon.user.dao.service.messaging;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			UserHuyenLocalServiceUtil.clearService();

			UserMappingLocalServiceUtil.clearService();

			UserTinhLocalServiceUtil.clearService();

			UserTramCapLocalServiceUtil.clearService();

			UserTULocalServiceUtil.clearService();
		}
	}
}