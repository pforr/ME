	...
	// fill data dau noi to list / reporting
		...
		public static List<ThongTinKiemDemVeSinhGiaDinhModel> getListThongTinKiemDemGdModelViewDetailWithThonXom(
			...
			try {
					...
					_log.info("resultBase"+resultBase.size());
					for (ThongTinKiemDemHoGD ThongTinKiemDemHoGD : resultBase) {
						ThongTinKiemDemVeSinhGiaDinhModel thongTinKiemDemVeSinhGiaDinhModel = new ThongTinKiemDemVeSinhGiaDinhModel();
						thongTinKiemDemVeSinhGiaDinhModel.setId(ThongTinKiemDemHoGD.getId());
						thongTinKiemDemVeSinhGiaDinhModel.setTenChuHo(ThongTinKiemDemHoGD.getTenChuHo());
						thongTinKiemDemVeSinhGiaDinhModel.setQuanHuyen(NuocSachUtils.getNameHuyen(ThongTinKiemDemHoGD.getMaTinh(),ThongTinKiemDemHoGD.getMaHuyen()));
						thongTinKiemDemVeSinhGiaDinhModel.setPhuongXa(NuocSachUtils.getNameXa(ThongTinKiemDemHoGD.getMaXa()));
						thongTinKiemDemVeSinhGiaDinhModel.setThonXom(ThongTinKiemDemHoGD.getThonXom());
						thongTinKiemDemVeSinhGiaDinhModel.setNgayKiemDem(Validator.isNotNull(ThongTinKiemDemHoGD.getNgayKiemDem())?FormatData.parseDateToTringDDMMYYY(ThongTinKiemDemHoGD.getNgayKiemDem()):StringPool.BLANK);
						thongTinKiemDemVeSinhGiaDinhModel.setTrangThai("da-ket-thuc-dieu-tra-"+ThongTinKiemDemHoGD.getDaKetThucDieuTra()+"");
						thongTinKiemDemVeSinhGiaDinhModel.setKetQuaKiemDem("danh-gia-kiem-dem-"+ThongTinKiemDemHoGD.getDanhGiaKiemDem());
						thongTinKiemDemVeSinhGiaDinhModel.setNgayKiemDemToolTip(Validator.isNotNull(ThongTinKiemDemHoGD.getNgayKiemDem())?FormatData.parseDateToTring(ThongTinKiemDemHoGD.getNgayKiemDem()) : StringPool.BLANK);
						results.add(thongTinKiemDemVeSinhGiaDinhModel);
						/*
						results.add(new ThongTinKiemDemVeSinhGiaDinhModel(ThongTinKiemDemHoGD.getId(), 
								ThongTinKiemDemHoGD.getTenChuHo(), 
								NuocSachUtils.getNameHuyen(ThongTinKiemDemHoGD.getMaTinh(),ThongTinKiemDemHoGD.getMaHuyen()), 
