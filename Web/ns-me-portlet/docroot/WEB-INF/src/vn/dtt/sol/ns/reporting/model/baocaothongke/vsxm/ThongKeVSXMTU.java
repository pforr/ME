...
public class ThongKeVSXMTU {
	private String nam;
	private List<ThongKeVSXMTUDanhSach> lstThongKeVSXMTUDanhSach;
	...
	public List<ThongKeVSXMTUDanhSach> getLstThongKeVSXMTUDanhSach() {
		return lstThongKeVSXMTUDanhSach;
	}
	public void setLstThongKeVSXMTUDanhSach(
			List<ThongKeVSXMTUDanhSach> lstThongKeVSXMTUDanhSach) {
		this.lstThongKeVSXMTUDanhSach = lstThongKeVSXMTUDanhSach;
	}
	public class ThongKeVSXMTUDanhSach{
