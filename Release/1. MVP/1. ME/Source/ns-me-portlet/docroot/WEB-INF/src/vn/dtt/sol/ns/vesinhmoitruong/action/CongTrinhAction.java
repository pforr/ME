...
public class CongTrinhAction extends MVCPortlet{
	...
	public void doView(RenderRequest renderRequest,
		...
		_log.info("vao doView");
		User user = null;
		UserMapping loginUserMapping = new UserMappingImpl();
		
		String maTinh = ParamUtil.getString(renderRequest, VeSinhCongTrinhTerms.MA_TINH);
		String maHuyen = ParamUtil.getString(renderRequest, VeSinhCongTrinhTerms.MA_HUYEN);
		String maXa = ParamUtil.getString(renderRequest, VeSinhCongTrinhTerms.MA_XA);
		String loaiNhaTieu = ParamUtil.getString(renderRequest, VeSinhCongTrinhTerms.LOAI_NHA_TIEU);
		String loaiCongTrinh = ParamUtil.getString(renderRequest, VeSinhCongTrinhTerms.LOAI_CONG_TRINH);
		String trangThai = ParamUtil.getString(renderRequest, VeSinhCongTrinhTerms.TRANG_THAI);
		String namBaoCao = ParamUtil.getString(renderRequest, VeSinhCongTrinhTerms.NAM_BAO_CAO);
		...
		try {
			...
			if(loginUserMapping.getUserType()==DauNoiNuocConstantString.UserMapping.CAP_TU){
				...
				if(Validator.isNotNull(maTinh)){
					...
					listHuyen = DataItemBusiness.getInLevel2(WebKeys.DATAGROUPID_DONVIHANHCHINH, listTinh.get(0).getNode1());
				}
		...
		renderRequest.setAttribute(VeSinhCongTrinhTerms.MA_TINH, maTinh);
		renderRequest.setAttribute(VeSinhCongTrinhTerms.MA_HUYEN, maHuyen);
		renderRequest.setAttribute(VeSinhCongTrinhTerms.MA_XA, maXa);
		renderRequest.setAttribute(VeSinhCongTrinhTerms.LOAI_NHA_TIEU, loaiNhaTieu);
		renderRequest.setAttribute(VeSinhCongTrinhTerms.LOAI_CONG_TRINH, loaiCongTrinh);
		renderRequest.setAttribute(VeSinhCongTrinhTerms.TRANG_THAI, trangThai);
		renderRequest.setAttribute(VeSinhCongTrinhTerms.NAM_BAO_CAO, namBaoCao);
	...
	public void render(RenderRequest request, RenderResponse response)
		...
		User user = null;
		UserMapping loginUserMapping = new UserMappingImpl();
		String maTinh = ParamUtil.getString(request, VeSinhCongTrinhTerms.MA_TINH);
		String maHuyen = ParamUtil.getString(request, VeSinhCongTrinhTerms.MA_HUYEN);
		String maXa = ParamUtil.getString(request, VeSinhCongTrinhTerms.MA_XA);
		String loaiNhaTieu = ParamUtil.getString(request, VeSinhCongTrinhTerms.LOAI_NHA_TIEU);
		String loaiCongTrinh = ParamUtil.getString(request, VeSinhCongTrinhTerms.LOAI_CONG_TRINH);
		String id = ParamUtil.getString(request, VeSinhCongTrinhTerms.ID);
		String trangThai = ParamUtil.getString(request, VeSinhCongTrinhTerms.TRANG_THAI);
		String namBaoCao = ParamUtil.getString(request, VeSinhCongTrinhTerms.NAM_BAO_CAO);
		...
		try {
			 ...
			 if(Validator.isNotNull(id)){
				 	veSinhCongTrinh = CongTrinhBussiness.fetchVeSinhCongTrinh(Integer.valueOf(id));
			...
			listLoaiNguonNuoc = DataItemBusiness.getByDataGroupId(WebKeys.DATAGROUPID_LOAINGUONNUOC);
		...
		request.setAttribute(VeSinhCongTrinhTerms.LOAI_CONG_TRINH, loaiCongTrinh);
	...
	public void addCongTrinh(ActionRequest actionRequest, ActionResponse actionResponse) throws IOException {
		boolean isSuccess = false;
		String messageKey = MessageErrors.ADD_CONG_TRINH_MESSAGE;
		long idReturn = 0;
		VeSinhCongTrinhTerms veSinhCongTrinhTerm = new VeSinhCongTrinhTerms(actionRequest);
		String add = "";
		...
		try {
			...
			if (add.equals(Constants.ADD)) {
				long id = 0;
				id = CounterLocalServiceUtil.increment(VeSinhCongTrinh.class.getName());
				veSinhCongTrinhEtt = VeSinhCongTrinhLocalServiceUtil.createVeSinhCongTrinh(Integer.valueOf(id+""));
				...
				veSinhCongTrinhEtt = VeSinhCongTrinhLocalServiceUtil.fetchVeSinhCongTrinh(veSinhCongTrinhTerm.getId());
				messageKey = MessageSuccess.EDIT_CONG_TRINH_MESSAGE;
				idReturn=veSinhCongTrinhEtt.getId();
			}
			veSinhCongTrinhEtt.setTenCongTrinh(veSinhCongTrinhTerm.getTenCongTrinh());
			veSinhCongTrinhEtt.setLoaiCongTrinh(veSinhCongTrinhTerm.getLoaiCongTrinh());
			veSinhCongTrinhEtt.setDiaChi(veSinhCongTrinhTerm.getDiaChi());
			veSinhCongTrinhEtt.setMaHuyen(veSinhCongTrinhTerm.getMaHuyen());
			veSinhCongTrinhEtt.setNhaTieuHVS(veSinhCongTrinhTerm.getNhaTieuHVS());
			
			veSinhCongTrinhEtt.setMaTinh(veSinhCongTrinhTerm.getMaTinh());
			veSinhCongTrinhEtt.setMaXa(veSinhCongTrinhTerm.getMaXa());
			veSinhCongTrinhEtt.setLoaiNhaTieu(veSinhCongTrinhEtt.getLoaiNhaTieu());
			veSinhCongTrinhEtt.setLoaiNguonNuoc(veSinhCongTrinhTerm.getLoaiNguonNuoc());
			...
			//update 
			VeSinhCongTrinhLocalServiceUtil.updateVeSinhCongTrinh(veSinhCongTrinhEtt);
			isSuccess = true;
		} catch (Exception e) {
			// TODO Auto-generated catch block
			_log.error(e);
...
//	
	public void addDanhGiaLaiCongTrinh(ActionRequest actionRequest, ActionResponse actionResponse) {
		VeSinhCongTrinhTerms veSinhCongTrinhTerm = new VeSinhCongTrinhTerms(actionRequest);
		...
		try {
			...
			veSinhCongTrinhEtt.setNhaTieuHVS(veSinhCongTrinhTerm.getNhaTieuHVS());
			veSinhCongTrinhEtt.setNgayKiemDem(veSinhCongTrinhTerm.getNgayKiemDem());
...
//			//update 
	...
	public void deleteCongTrinh(ActionRequest actionRequest, ActionResponse actionResponse) throws IOException {
		boolean isSuccess = false;
		String messageKey = MessageErrors.XOA_CONG_TRINH_MESSAGE;
		long idReturn = 0;
		VeSinhCongTrinhTerms veSinhGiaDinhTerm = new VeSinhCongTrinhTerms(actionRequest);
		try {
...
//				SessionMessages.add(actionRequest, PortalUtil.getPortletId(actionRequest) + SessionMessages.KEY_SUFFIX_HIDE_DEFAULT_SUCCESS_MESSAGE);
				...
				successURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.MA_TINH+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.MA_TINH);
				successURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.MA_HUYEN+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.MA_HUYEN);
				successURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.MA_XA+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.MA_XA);
				successURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.LOAI_NHA_TIEU+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.LOAI_NHA_TIEU);
				successURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.LOAI_CONG_TRINH+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.LOAI_CONG_TRINH);
				successURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.TRANG_THAI+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.TRANG_THAI);
				successURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.NAM_BAO_CAO+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.NAM_BAO_CAO);
				if(id>0){
					successURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.ID+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.ID);
				}
...
//				SessionMessages.add(actionRequest, PortalUtil.getPortletId(actionRequest) + SessionMessages.KEY_SUFFIX_HIDE_DEFAULT_ERROR_MESSAGE);	
				...
				errorURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.MA_TINH+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.MA_TINH);
				errorURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.MA_HUYEN+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.MA_HUYEN);
				errorURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.MA_XA+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.MA_XA);
				errorURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.LOAI_NHA_TIEU+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.LOAI_NHA_TIEU);
				errorURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.LOAI_CONG_TRINH+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.LOAI_CONG_TRINH);
				errorURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.TRANG_THAI+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.TRANG_THAI);
				errorURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.NAM_BAO_CAO+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.NAM_BAO_CAO);
				if(id>0){
					errorURL+="&"+actionResponse.getNamespace()+VeSinhCongTrinhTerms.ID+"="+ParamUtil.getString(actionRequest, VeSinhCongTrinhTerms.ID);
				}
