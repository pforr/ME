...
<liferay-portlet:resourceURL var="inExcelKeHoachVS">
	<liferay-portlet:param name="typeRS" value="<%=ReportConstant.KHVS %>" ></liferay-portlet:param>
...
<liferay-ui:icon message="tai-excel-kehoach" image="download" url="<%=inExcelKeHoachVS %>" />
<style>
.dongKeHoachSpan{
padding-left: 10px;
}
