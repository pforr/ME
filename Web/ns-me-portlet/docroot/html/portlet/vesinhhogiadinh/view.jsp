...
<%
	...
	String danhGiaKiemDem = (String)request.getAttribute(VeSinhGiaDinhTerms.DANH_GIA_KIEM_DEM);
	String ngayTao =  (String)request.getAttribute(VeSinhGiaDinhTerms.NGAY_TAO);
	String ngayKiemDem = (String)request.getAttribute(VeSinhGiaDinhTerms.NGAY_KIEM_DEM);
	String giamSatVien = (String)request.getAttribute(VeSinhGiaDinhTerms.GIAM_SAT_VIEN);
	String kiemDemVien = (String)request.getAttribute(VeSinhGiaDinhTerms.KIEM_DEM_VIEN);
	String thonXom = (String)request.getAttribute(VeSinhGiaDinhTerms.THON_XOM);
	System.out.println(ngayKiemDem + "=*====>");
	System.out.println(kiemDemVien + "=====>");
	int startYear = 2014;
...
<aui:form action="<%= searchURL %>" method="get" name="fm2">
	...
	<liferay-portlet:renderURL varImpl="iteratorURL">
		...
		<liferay-portlet:param name="<%=VeSinhGiaDinhTerms.DANH_GIA_KIEM_DEM %>" value="<%=danhGiaKiemDem %>"></liferay-portlet:param>
		<liferay-portlet:param name="<%=VeSinhGiaDinhTerms.NGAY_TAO %>" value="<%=ngayTao %>"></liferay-portlet:param>
		<liferay-portlet:param name="<%=VeSinhGiaDinhTerms.NGAY_KIEM_DEM %>" value="<%=ngayKiemDem %>"></liferay-portlet:param>
		<liferay-portlet:param name="<%=VeSinhGiaDinhTerms.GIAM_SAT_VIEN %>" value="<%=giamSatVien %>"></liferay-portlet:param>
		<liferay-portlet:param name="<%=VeSinhGiaDinhTerms.KIEM_DEM_VIEN %>" value="<%=kiemDemVien %>"></liferay-portlet:param>
		<liferay-portlet:param name="<%=VeSinhGiaDinhTerms.THON_XOM %>" value="<%=thonXom %>"></liferay-portlet:param>
