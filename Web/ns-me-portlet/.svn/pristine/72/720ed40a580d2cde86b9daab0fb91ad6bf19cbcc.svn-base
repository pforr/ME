...
/**
 * Provides the remote service interface for DATAITEM. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author khoa.vu
 * @see DATAITEMServiceUtil
...
public interface DATAITEMService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DATAITEMServiceUtil} to access the d a t a i t e m remote service. Add custom service methods to {@link vn.dtt.cmon.dm.dao.service.impl.DATAITEMServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
