...
import vn.dtt.cmon.user.dao.service.UserTinhLocalService;
...
/**
 * Provides the base implementation for the user tinh local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.user.dao.service.impl.UserTinhLocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 ...
 * @generated
 */
public abstract class UserTinhLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UserTinhLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.user.dao.service.UserTinhLocalServiceUtil} to access the user tinh local service.
	 */
	...
	@Override
	public UserTinh addUserTinh(UserTinh userTinh) throws SystemException {
		userTinh.setNew(true);

		return userTinhPersistence.update(userTinh);
	}
	 ...
	 */
	@Override
	public UserTinh createUserTinh(long id) {
		return userTinhPersistence.create(id);
	}
	...
	@Override
	public UserTinh deleteUserTinh(long id)
		throws PortalException, SystemException {
		return userTinhPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserTinh deleteUserTinh(UserTinh userTinh) throws SystemException {
		return userTinhPersistence.remove(userTinh);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserTinh.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userTinhPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userTinhPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return userTinhPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userTinhPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserTinh fetchUserTinh(long id) throws SystemException {
		return userTinhPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public UserTinh getUserTinh(long id)
		throws PortalException, SystemException {
		return userTinhPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userTinhPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserTinh> getUserTinhs(int start, int end)
		throws SystemException {
		return userTinhPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserTinhsCount() throws SystemException {
		return userTinhPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserTinh updateUserTinh(UserTinh userTinh) throws SystemException {
		return userTinhPersistence.update(userTinh);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.user.dao.model.UserTinh",
			userTinhLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userTinhPersistence.getDataSource();
	...
	private UserTinhLocalServiceClpInvoker _clpInvoker = new UserTinhLocalServiceClpInvoker();
}