...
public class ThongKeVSTXTU {
	private String nam;
	private List<ThongKeVSTXTUDanhSach> lstThongKeVSTXTUDanhSach;
	...
	public List<ThongKeVSTXTUDanhSach> getLstThongKeVSTXTUDanhSach() {
		return lstThongKeVSTXTUDanhSach;
	}

	public void setLstThongKeVSTXTUDanhSach(
			List<ThongKeVSTXTUDanhSach> lstThongKeVSTXTUDanhSach) {
		this.lstThongKeVSTXTUDanhSach = lstThongKeVSTXTUDanhSach;
	}

	public class ThongKeVSTXTUDanhSach{
