...
/**
 * Provides the local service interface for UserTinh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoa.vu
 * @see UserTinhLocalServiceUtil
...
public interface UserTinhLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserTinhLocalServiceUtil} to access the user tinh local service. Add custom service methods to {@link vn.dtt.cmon.user.dao.service.impl.UserTinhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
