...
import vn.dtt.sol.ns.tramcap.dao.service.KeHoachKiemDemNuocLocalService;
...
/**
 * Provides the base implementation for the ke hoach kiem dem nuoc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.sol.ns.tramcap.dao.service.impl.KeHoachKiemDemNuocLocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 ...
 * @generated
 */
public abstract class KeHoachKiemDemNuocLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements KeHoachKiemDemNuocLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.sol.ns.tramcap.dao.service.KeHoachKiemDemNuocLocalServiceUtil} to access the ke hoach kiem dem nuoc local service.
	 */
	...
	@Override
	public KeHoachKiemDemNuoc addKeHoachKiemDemNuoc(
		KeHoachKiemDemNuoc keHoachKiemDemNuoc) throws SystemException {
		keHoachKiemDemNuoc.setNew(true);

		return keHoachKiemDemNuocPersistence.update(keHoachKiemDemNuoc);
	}
	 ...
	 */
	@Override
	public KeHoachKiemDemNuoc createKeHoachKiemDemNuoc(int id) {
		return keHoachKiemDemNuocPersistence.create(id);
	}
	...
	@Override
	public KeHoachKiemDemNuoc deleteKeHoachKiemDemNuoc(int id)
		throws PortalException, SystemException {
		return keHoachKiemDemNuocPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KeHoachKiemDemNuoc deleteKeHoachKiemDemNuoc(
		KeHoachKiemDemNuoc keHoachKiemDemNuoc) throws SystemException {
		return keHoachKiemDemNuocPersistence.remove(keHoachKiemDemNuoc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(KeHoachKiemDemNuoc.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return keHoachKiemDemNuocPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return keHoachKiemDemNuocPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public KeHoachKiemDemNuoc fetchKeHoachKiemDemNuoc(int id)
		throws SystemException {
		return keHoachKiemDemNuocPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public KeHoachKiemDemNuoc getKeHoachKiemDemNuoc(int id)
		throws PortalException, SystemException {
		return keHoachKiemDemNuocPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return keHoachKiemDemNuocPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<KeHoachKiemDemNuoc> getKeHoachKiemDemNuocs(int start, int end)
		throws SystemException {
		return keHoachKiemDemNuocPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getKeHoachKiemDemNuocsCount() throws SystemException {
		return keHoachKiemDemNuocPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KeHoachKiemDemNuoc updateKeHoachKiemDemNuoc(
		KeHoachKiemDemNuoc keHoachKiemDemNuoc) throws SystemException {
		return keHoachKiemDemNuocPersistence.update(keHoachKiemDemNuoc);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.sol.ns.tramcap.dao.model.KeHoachKiemDemNuoc",
			keHoachKiemDemNuocLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = keHoachKiemDemNuocPersistence.getDataSource();
	...
	private KeHoachKiemDemNuocLocalServiceClpInvoker _clpInvoker = new KeHoachKiemDemNuocLocalServiceClpInvoker();
}