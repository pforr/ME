...
import vn.dtt.cmon.user.dao.service.UserTULocalService;
...
/**
 * Provides the base implementation for the user t u local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.user.dao.service.impl.UserTULocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 ...
 * @generated
 */
public abstract class UserTULocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UserTULocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.user.dao.service.UserTULocalServiceUtil} to access the user t u local service.
	 */
	...
	@Override
	public UserTU addUserTU(UserTU userTU) throws SystemException {
		userTU.setNew(true);

		return userTUPersistence.update(userTU);
	}
	 ...
	 */
	@Override
	public UserTU createUserTU(long id) {
		return userTUPersistence.create(id);
	}
	...
	@Override
	public UserTU deleteUserTU(long id) throws PortalException, SystemException {
		return userTUPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserTU deleteUserTU(UserTU userTU) throws SystemException {
		return userTUPersistence.remove(userTU);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserTU.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return userTUPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userTUPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userTUPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery,
		...
		return userTUPersistence.countWithDynamicQuery(dynamicQuery, projection);
	}

	@Override
	public UserTU fetchUserTU(long id) throws SystemException {
		return userTUPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public UserTU getUserTU(long id) throws PortalException, SystemException {
		return userTUPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userTUPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserTU> getUserTUs(int start, int end)
		throws SystemException {
		return userTUPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserTUsCount() throws SystemException {
		return userTUPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserTU updateUserTU(UserTU userTU) throws SystemException {
		return userTUPersistence.update(userTU);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.user.dao.model.UserTU",
			userTULocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userTUPersistence.getDataSource();
	...
	private UserTULocalServiceClpInvoker _clpInvoker = new UserTULocalServiceClpInvoker();
}