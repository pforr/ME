...
public class BaoCaoDLIClp extends BaseModelImpl<BaoCaoDLI> implements BaoCaoDLI {
	...
	public void setKeHoachNam(String keHoachNam) {
		...
		if (_baoCaoDLIRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setKeHoachNam", String.class);

				method.invoke(_baoCaoDLIRemoteModel, keHoachNam);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayPheDuyet(Date ngayPheDuyet) {
		...
		if (_baoCaoDLIRemoteModel != null) {
			try {
				...
				Method method = clazz.getMethod("setNgayPheDuyet", Date.class);

				method.invoke(_baoCaoDLIRemoteModel, ngayPheDuyet);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setBaoCaoChuongTrinh(String baoCaoChuongTrinh) {
		...
		if (_baoCaoDLIRemoteModel != null) {
			try {
				...
				method.invoke(_baoCaoDLIRemoteModel, baoCaoChuongTrinh);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public void setNgayDang(Date ngayDang) {
		...
		if (_baoCaoDLIRemoteModel != null) {
			try {
				...
				method.invoke(_baoCaoDLIRemoteModel, ngayDang);
			}
			catch (Exception e) {
				throw new UnsupportedOperationException(e);
			}
	...
	public Object clone() {
		...
		clone.setKeHoachNam(getKeHoachNam());
		clone.setNgayPheDuyet(getNgayPheDuyet());
	...
	public String toString() {
		...
		sb.append(", keHoachNam=");
		sb.append(getKeHoachNam());
		sb.append(", ngayPheDuyet=");
		sb.append(getNgayPheDuyet());
	...
	public String toXmlString() {
		...
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>keHoachNam</column-name><column-value><![CDATA[");
		sb.append(getKeHoachNam());
		sb.append("]]></column-value></column>");
		sb.append(
			"<column><column-name>ngayPheDuyet</column-name><column-value><![CDATA[");
		sb.append(getNgayPheDuyet());
		sb.append("]]></column-value></column>");
		sb.append(
