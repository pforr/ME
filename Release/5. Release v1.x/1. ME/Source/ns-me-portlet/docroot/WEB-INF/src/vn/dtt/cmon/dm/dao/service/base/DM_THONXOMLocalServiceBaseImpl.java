...
import vn.dtt.cmon.dm.dao.service.DM_THONXOMLocalService;
...
/**
 * Provides the base implementation for the d m_ t h o n x o m local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.dm.dao.service.impl.DM_THONXOMLocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 * @see vn.dtt.cmon.dm.dao.service.impl.DM_THONXOMLocalServiceImpl
 * @see vn.dtt.cmon.dm.dao.service.DM_THONXOMLocalServiceUtil
 * @generated
 */
public abstract class DM_THONXOMLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DM_THONXOMLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.dm.dao.service.DM_THONXOMLocalServiceUtil} to access the d m_ t h o n x o m local service.
	 */
	...
	@Override
	public DM_THONXOM addDM_THONXOM(DM_THONXOM dm_thonxom)
		throws SystemException {
		dm_thonxom.setNew(true);

		return dm_thonxomPersistence.update(dm_thonxom);
	}
	 ...
	 */
	@Override
	public DM_THONXOM createDM_THONXOM(long id) {
		return dm_thonxomPersistence.create(id);
	}
	...
	@Override
	public DM_THONXOM deleteDM_THONXOM(long id)
		throws PortalException, SystemException {
		return dm_thonxomPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DM_THONXOM deleteDM_THONXOM(DM_THONXOM dm_thonxom)
		throws SystemException {
		return dm_thonxomPersistence.remove(dm_thonxom);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DM_THONXOM.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dm_thonxomPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dm_thonxomPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dm_thonxomPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DM_THONXOM fetchDM_THONXOM(long id) throws SystemException {
		return dm_thonxomPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DM_THONXOM getDM_THONXOM(long id)
		throws PortalException, SystemException {
		return dm_thonxomPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dm_thonxomPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DM_THONXOM> getDM_THONXOMs(int start, int end)
		throws SystemException {
		return dm_thonxomPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDM_THONXOMsCount() throws SystemException {
		return dm_thonxomPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DM_THONXOM updateDM_THONXOM(DM_THONXOM dm_thonxom)
		throws SystemException {
		return dm_thonxomPersistence.update(dm_thonxom);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.dm.dao.model.DM_THONXOM",
			dm_thonxomLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dm_thonxomPersistence.getDataSource();
	...
	private DM_THONXOMLocalServiceClpInvoker _clpInvoker = new DM_THONXOMLocalServiceClpInvoker();
}