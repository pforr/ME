...
import vn.dtt.sol.ns.tramcap.dao.service.TramCapNuocLocalService;
...
/**
 * Provides the base implementation for the tram cap nuoc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.sol.ns.tramcap.dao.service.impl.TramCapNuocLocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 ...
 * @generated
 */
public abstract class TramCapNuocLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TramCapNuocLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.sol.ns.tramcap.dao.service.TramCapNuocLocalServiceUtil} to access the tram cap nuoc local service.
	 */
	...
	@Override
	public TramCapNuoc addTramCapNuoc(TramCapNuoc tramCapNuoc)
		throws SystemException {
		tramCapNuoc.setNew(true);

		return tramCapNuocPersistence.update(tramCapNuoc);
	}
	 ...
	 */
	@Override
	public TramCapNuoc createTramCapNuoc(long id) {
		return tramCapNuocPersistence.create(id);
	}
	...
	@Override
	public TramCapNuoc deleteTramCapNuoc(long id)
		throws PortalException, SystemException {
		return tramCapNuocPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public TramCapNuoc deleteTramCapNuoc(TramCapNuoc tramCapNuoc)
		throws SystemException {
		return tramCapNuocPersistence.remove(tramCapNuoc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(TramCapNuoc.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return tramCapNuocPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return tramCapNuocPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return tramCapNuocPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public TramCapNuoc fetchTramCapNuoc(long id) throws SystemException {
		return tramCapNuocPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public TramCapNuoc getTramCapNuoc(long id)
		throws PortalException, SystemException {
		return tramCapNuocPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return tramCapNuocPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<TramCapNuoc> getTramCapNuocs(int start, int end)
		throws SystemException {
	 ...
	 */
	@Override
	public int getTramCapNuocsCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public TramCapNuoc updateTramCapNuoc(TramCapNuoc tramCapNuoc)
		throws SystemException {
		return tramCapNuocPersistence.update(tramCapNuoc);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.sol.ns.tramcap.dao.model.TramCapNuoc",
			tramCapNuocLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = tramCapNuocPersistence.getDataSource();
	...
	private TramCapNuocLocalServiceClpInvoker _clpInvoker = new TramCapNuocLocalServiceClpInvoker();
}