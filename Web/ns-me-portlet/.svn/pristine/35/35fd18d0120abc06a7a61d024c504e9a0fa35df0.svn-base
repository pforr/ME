 ...
 * @generated
 */
public abstract class KeHoachKiemDemNuocActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public KeHoachKiemDemNuocActionableDynamicQuery() throws SystemException {
		setBaseLocalService(KeHoachKiemDemNuocLocalServiceUtil.getService());
		setClass(KeHoachKiemDemNuoc.class);
