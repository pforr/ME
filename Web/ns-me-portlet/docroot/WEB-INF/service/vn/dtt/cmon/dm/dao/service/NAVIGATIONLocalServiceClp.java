 ...
 * @generated
 */
public class NAVIGATIONLocalServiceClp implements NAVIGATIONLocalService {
	public NAVIGATIONLocalServiceClp(
	...
	public vn.dtt.cmon.dm.dao.model.NAVIGATION addNAVIGATION(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(navigation) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.cmon.dm.dao.model.NAVIGATION)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.dm.dao.model.NAVIGATION> getNAVIGATIONs(
		...
		return (java.util.List<vn.dtt.cmon.dm.dao.model.NAVIGATION>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.dm.dao.model.NAVIGATION> getLeftMenu(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					_methodParameterTypes19, new Object[] { parentId, hidden });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
