...
import vn.dtt.cmon.user.dao.service.UserHuyenLocalService;
...
/**
 * Provides the base implementation for the user huyen local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.cmon.user.dao.service.impl.UserHuyenLocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 ...
 * @generated
 */
public abstract class UserHuyenLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements UserHuyenLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.cmon.user.dao.service.UserHuyenLocalServiceUtil} to access the user huyen local service.
	 */
	...
	@Override
	public UserHuyen addUserHuyen(UserHuyen userHuyen)
		throws SystemException {
		userHuyen.setNew(true);

		return userHuyenPersistence.update(userHuyen);
	}
	 ...
	 */
	@Override
	public UserHuyen createUserHuyen(long id) {
		return userHuyenPersistence.create(id);
	}
	...
	@Override
	public UserHuyen deleteUserHuyen(long id)
		throws PortalException, SystemException {
		return userHuyenPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public UserHuyen deleteUserHuyen(UserHuyen userHuyen)
		throws SystemException {
		return userHuyenPersistence.remove(userHuyen);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(UserHuyen.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return userHuyenPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return userHuyenPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return userHuyenPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public UserHuyen fetchUserHuyen(long id) throws SystemException {
		return userHuyenPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public UserHuyen getUserHuyen(long id)
		throws PortalException, SystemException {
		return userHuyenPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return userHuyenPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<UserHuyen> getUserHuyens(int start, int end)
		throws SystemException {
		return userHuyenPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getUserHuyensCount() throws SystemException {
		return userHuyenPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public UserHuyen updateUserHuyen(UserHuyen userHuyen)
		throws SystemException {
		return userHuyenPersistence.update(userHuyen);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.cmon.user.dao.model.UserHuyen",
			userHuyenLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = userHuyenPersistence.getDataSource();
	...
	private UserHuyenLocalServiceClpInvoker _clpInvoker = new UserHuyenLocalServiceClpInvoker();
}