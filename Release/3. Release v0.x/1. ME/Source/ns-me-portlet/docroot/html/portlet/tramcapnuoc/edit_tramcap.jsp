...
<%
	...
	if (Validator.isNotNull(initTinh)) {
		listTinh.add(NuocSachUtils.getDATAITEMTinh(initTinh));
	} else {
	...
	<aui:row>
		<aui:col width="60">
			...
			<aui:row>
				...
				<aui:row>
					<aui:col width="50">
						<aui:input name="namXayDung" cssClass="input50">
							<aui:validator name="number"></aui:validator>
						</aui:input>
					</aui:col>
					<aui:col width="50">
						<aui:input name="namHoanThanh" cssClass="input50">
							<aui:validator name="number"></aui:validator>
						</aui:input>
					</aui:col>
				</aui:row>
