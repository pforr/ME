...
/**
 * The persistence utility for the ve sinh cong trinh service. This utility wraps {@link VeSinhCongTrinhPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class VeSinhCongTrinhUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(VeSinhCongTrinh veSinhCongTrinh) {
		getPersistence().clearCache(veSinhCongTrinh);
	}
	 ...
	 */
	public static List<VeSinhCongTrinh> findWithDynamicQuery(
	 ...
	 */
	public static VeSinhCongTrinh update(VeSinhCongTrinh veSinhCongTrinh)
		throws SystemException {
		return getPersistence().update(veSinhCongTrinh);
	}
	...
	public static VeSinhCongTrinh update(VeSinhCongTrinh veSinhCongTrinh,
		...
		return getPersistence().update(veSinhCongTrinh, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(veSinhCongTrinh);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(veSinhCongTrinhs);
	}
	...
	*/
	public static vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhCongTrinh create(
		int id) {
	...
	*/
	public static vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhCongTrinh remove(
		int id)
	...
	public static vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhCongTrinh updateImpl(
		vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhCongTrinh veSinhCongTrinh)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(veSinhCongTrinh);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhCongTrinh findByPrimaryKey(
		int id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.sol.ns.vesinhmoitruong.dao.NoSuchVeSinhCongTrinhException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhCongTrinh fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhCongTrinh> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static VeSinhCongTrinhPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (VeSinhCongTrinhPersistence)PortletBeanLocatorUtil.locate(vn.dtt.sol.ns.vesinhmoitruong.dao.service.ClpSerializer.getServletContextName(),
					VeSinhCongTrinhPersistence.class.getName());

			ReferenceRegistry.registerReference(VeSinhCongTrinhUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(VeSinhCongTrinhPersistence persistence) {
	}

	private static VeSinhCongTrinhPersistence _persistence;
}