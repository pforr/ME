...
<liferay-ui:header
	backURL="<%= redirectURL %>"
	title='<%= Validator.isNotNull(userMapping) ? "edit-user-mapping-cap-tram" : "add-user-mapping-cap-tram" %>'
/>
...
<aui:form action="<%= formAction %>" method="post" name="fm">
	...
	<aui:input name="userType" type="hidden" value="4"/>
	...
	<div class="add-user-tramcap-wrapper">
		<liferay-ui:form-navigator
			...
			jspPath="/html/portlet/usermapping/usertramcap/"
		/>
	</div>
</aui:form>
