...
import vn.dtt.sol.ns.vesinhmoitruong.dao.service.VeSinhCongTrinhLocalService;
...
/**
 * Provides the base implementation for the ve sinh cong trinh local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.impl.VeSinhCongTrinhLocalServiceImpl}.
 * </p>
 *
 * @author BinhTH
 ...
 * @generated
 */
public abstract class VeSinhCongTrinhLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements VeSinhCongTrinhLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.VeSinhCongTrinhLocalServiceUtil} to access the ve sinh cong trinh local service.
	 */
	...
	@Override
	public VeSinhCongTrinh addVeSinhCongTrinh(VeSinhCongTrinh veSinhCongTrinh)
		throws SystemException {
		veSinhCongTrinh.setNew(true);

		return veSinhCongTrinhPersistence.update(veSinhCongTrinh);
	}
	 ...
	 */
	@Override
	public VeSinhCongTrinh createVeSinhCongTrinh(int id) {
		return veSinhCongTrinhPersistence.create(id);
	}
	...
	@Override
	public VeSinhCongTrinh deleteVeSinhCongTrinh(int id)
		throws PortalException, SystemException {
		return veSinhCongTrinhPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public VeSinhCongTrinh deleteVeSinhCongTrinh(
		VeSinhCongTrinh veSinhCongTrinh) throws SystemException {
		return veSinhCongTrinhPersistence.remove(veSinhCongTrinh);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(VeSinhCongTrinh.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return veSinhCongTrinhPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return veSinhCongTrinhPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public VeSinhCongTrinh fetchVeSinhCongTrinh(int id)
		throws SystemException {
		return veSinhCongTrinhPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public VeSinhCongTrinh getVeSinhCongTrinh(int id)
		throws PortalException, SystemException {
		return veSinhCongTrinhPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return veSinhCongTrinhPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<VeSinhCongTrinh> getVeSinhCongTrinhs(int start, int end)
		throws SystemException {
		return veSinhCongTrinhPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getVeSinhCongTrinhsCount() throws SystemException {
		return veSinhCongTrinhPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public VeSinhCongTrinh updateVeSinhCongTrinh(
		VeSinhCongTrinh veSinhCongTrinh) throws SystemException {
		return veSinhCongTrinhPersistence.update(veSinhCongTrinh);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.sol.ns.vesinhmoitruong.dao.model.VeSinhCongTrinh",
			veSinhCongTrinhLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = veSinhCongTrinhPersistence.getDataSource();
	...
	private VeSinhCongTrinhLocalServiceClpInvoker _clpInvoker = new VeSinhCongTrinhLocalServiceClpInvoker();
}