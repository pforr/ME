...
/**
 * The persistence utility for the ke hoach kiem dem nuoc service. This utility wraps {@link KeHoachKiemDemNuocPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class KeHoachKiemDemNuocUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(KeHoachKiemDemNuoc keHoachKiemDemNuoc) {
		getPersistence().clearCache(keHoachKiemDemNuoc);
	}
	 ...
	 */
	public static List<KeHoachKiemDemNuoc> findWithDynamicQuery(
	 ...
	 */
	public static KeHoachKiemDemNuoc update(
		KeHoachKiemDemNuoc keHoachKiemDemNuoc) throws SystemException {
		return getPersistence().update(keHoachKiemDemNuoc);
	}
	 ...
	 */
	public static KeHoachKiemDemNuoc update(
		KeHoachKiemDemNuoc keHoachKiemDemNuoc, ServiceContext serviceContext)
		throws SystemException {
		return getPersistence().update(keHoachKiemDemNuoc, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(keHoachKiemDemNuoc);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(keHoachKiemDemNuocs);
	}
	...
	*/
	public static vn.dtt.sol.ns.tramcap.dao.model.KeHoachKiemDemNuoc create(
		int id) {
	...
	*/
	public static vn.dtt.sol.ns.tramcap.dao.model.KeHoachKiemDemNuoc remove(
		int id)
	...
	public static vn.dtt.sol.ns.tramcap.dao.model.KeHoachKiemDemNuoc updateImpl(
		vn.dtt.sol.ns.tramcap.dao.model.KeHoachKiemDemNuoc keHoachKiemDemNuoc)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(keHoachKiemDemNuoc);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.tramcap.dao.model.KeHoachKiemDemNuoc findByPrimaryKey(
		int id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.sol.ns.tramcap.dao.NoSuchKeHoachKiemDemNuocException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.tramcap.dao.model.KeHoachKiemDemNuoc fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.sol.ns.tramcap.dao.model.KeHoachKiemDemNuoc> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static KeHoachKiemDemNuocPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (KeHoachKiemDemNuocPersistence)PortletBeanLocatorUtil.locate(vn.dtt.sol.ns.tramcap.dao.service.ClpSerializer.getServletContextName(),
					KeHoachKiemDemNuocPersistence.class.getName());

			ReferenceRegistry.registerReference(KeHoachKiemDemNuocUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(KeHoachKiemDemNuocPersistence persistence) {
	}

	private static KeHoachKiemDemNuocPersistence _persistence;
}