...
public class DauNoiNuocAction extends MVCPortlet {
	...
	public void doView(RenderRequest renderRequest,
		...
		String ngayNhap = ParamUtil.getString(renderRequest, "ngayNhap").replaceAll(
				"-", "/");
		String idNguoiTao = ParamUtil.getString(renderRequest, "idNguoiTao");
		String advText = ParamUtil.getString(renderRequest, "advText");
		
		String giamSatVienId =ParamUtil.getString(renderRequest,DauNoiNuocDisplayTerms.GIAM_SAT_VIEN_ID); 
		
		String ketQuaKiemDem = ParamUtil.getString(renderRequest,DauNoiNuocDisplayTerms.KET_QUA_KIEM_DEM);
		String kiemDemvienId = ParamUtil.getString(renderRequest,DauNoiNuocDisplayTerms.KIEM_DEM_VIEN_ID);
		String ngayKiemDem = ParamUtil.getString(renderRequest,"ngayKiemDem").replaceAll("-", "/");
		System.out.println("BAA -------------------------"+ giamSatVienId);
		...
		renderRequest.setAttribute(DauNoiNuocDisplayTerms.GIAM_SAT_VIEN_ID, giamSatVienId);
		
		renderRequest.setAttribute(DauNoiNuocDisplayTerms.KET_QUA_KIEM_DEM, ketQuaKiemDem);
		renderRequest.setAttribute(DauNoiNuocDisplayTerms.KIEM_DEM_VIEN_ID, kiemDemvienId);
		renderRequest.setAttribute("ngayKiemDem", ngayKiemDem);
	...
	public void render(RenderRequest request, RenderResponse response)
		...
		String giamSatVienId =ParamUtil.getString(request,DauNoiNuocDisplayTerms.GIAM_SAT_VIEN_ID); 
		
		String ketQuaKiemDem = ParamUtil.getString(request,DauNoiNuocDisplayTerms.KET_QUA_KIEM_DEM);
		String kiemDemvienId = ParamUtil.getString(request,DauNoiNuocDisplayTerms.KIEM_DEM_VIEN_ID);
		String ngayKiemDem = ParamUtil.getString(request,"ngayKiemDem").replaceAll("-", "/");
		...
		request.setAttribute(DauNoiNuocDisplayTerms.GIAM_SAT_VIEN_ID, giamSatVienId);
		
		request.setAttribute(DauNoiNuocDisplayTerms.KET_QUA_KIEM_DEM, ketQuaKiemDem);
		request.setAttribute(DauNoiNuocDisplayTerms.KIEM_DEM_VIEN_ID, kiemDemvienId);
		request.setAttribute("ngayKiemDem", ngayKiemDem);
