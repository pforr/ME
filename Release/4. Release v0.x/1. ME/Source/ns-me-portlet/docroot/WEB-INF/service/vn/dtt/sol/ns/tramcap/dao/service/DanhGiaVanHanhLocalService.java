...
/**
 * Provides the local service interface for DanhGiaVanHanh. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoa.vu
 * @see DanhGiaVanHanhLocalServiceUtil
...
public interface DanhGiaVanHanhLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DanhGiaVanHanhLocalServiceUtil} to access the danh gia van hanh local service. Add custom service methods to {@link vn.dtt.sol.ns.tramcap.dao.service.impl.DanhGiaVanHanhLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
