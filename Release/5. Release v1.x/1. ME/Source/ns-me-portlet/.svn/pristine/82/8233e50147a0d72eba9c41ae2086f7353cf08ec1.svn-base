 ...
 * @generated
 */
public abstract class DanhGiaVeSinhXaNewFakeActionableDynamicQuery
	extends BaseActionableDynamicQuery {
	public DanhGiaVeSinhXaNewFakeActionableDynamicQuery()
		throws SystemException {
		setBaseLocalService(DanhGiaVeSinhXaNewFakeLocalServiceUtil.getService());
		setClass(DanhGiaVeSinhXaNewFake.class);
