...
public class DSNhaTieuHGDXayMoiExport {
	...
	public static DSNhaTieuHGDXayMoi getModel(String namBaoCao, String maTinh, String soBaoCao, String ngayBaoCao, String nguoiLap, String nguoiDuyet, String thoigianthuc ) {
		String tichCo = "1";
		String[] DANHGIAKIEMDEM = {"1","2"};// danhgiakiemdem 1 la co nha tieu hvs xay moi, 2 la nha tieu hvs
		String DAKETTHUCDIEUTRA = "1";// 1 la da ket thuc di kiem dem, bo sung 7/1/2016
		
		String[] TRANGTHAI = {"2","3"}; // trangthai 2 la co nha tieu hvs xay moi, 3 la co nha tieu hvs
		log.info("==START DLI 1.2 CT Tinh=DSNhaTieuHGDXayMoiExport===");
		...
		if(thoigianthuc.equalsIgnoreCase(ReportConstant.THUC)){
			...
			List<ThongTinKiemDemHoGD> lstThongTinKiemDemHoGD = ThongTinKiemDemHoGDBusiness.getThongTinKiemDemHGDThoiGianThuc(maTinh, namBaoCao, DANHGIAKIEMDEM,DAKETTHUCDIEUTRA);
			...
			List<VeSinhGiaDinh> lstVeSinhGiaDinh = VeSinhGiaDinhBusiness.getVeSinhGiaDinhThoiGianChot(maTinh, null, null, null, TRANGTHAI, namBaoCao);
		...
		log.info("==END DLI 1.2 CT Tinh=DSNhaTieuHGDXayMoiExport===");
		return result;
	}
}
