...
/**
 * Provides the local service interface for UserTU. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoa.vu
 * @see UserTULocalServiceUtil
...
public interface UserTULocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link UserTULocalServiceUtil} to access the user t u local service. Add custom service methods to {@link vn.dtt.cmon.user.dao.service.impl.UserTULocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
