...
<%
	...
	}else if(typeKiemDem == WebKeys.KDV_VSHUYEN){
		type = WebKeys.KDV_VSHUYEN;
...
<aui:select cssClass="input1001" required="true" name="<%=KeHoachKiemDemVeSinhTerms.KIEM_DEM_VIEN_ID %>" id="<%=KeHoachKiemDemVeSinhTerms.KIEM_DEM_VIEN_ID %>"  label="<%= LanguageUtil.get(pageContext, \"kiem-dem-vien\") +\" \"+requiredLabel + dotLabel %>" showEmptyOption="<%= false %>">
