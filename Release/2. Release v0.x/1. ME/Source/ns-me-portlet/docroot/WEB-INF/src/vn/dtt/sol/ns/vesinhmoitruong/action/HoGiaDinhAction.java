...
//						isNext = 0;
						...
						case 6:
							cell.setCellType(Cell.CELL_TYPE_STRING);
							if(typeImport==1){
								ett.setKhongCoNhaTieu(cell.getStringCellValue().length());
							}else{
						...
						case 7:
							cell.setCellType(Cell.CELL_TYPE_STRING);
							if(typeImport==1){
								ett.setCoNhaTieuKhongHVS(cell.getStringCellValue().length());
							}else{
								if(cell.getStringCellValue().length()>0){
...
//							break;	
						case 8:
							...
							if(typeImport==1){
								...
								if(cell.getStringCellValue().length()>0 && Validator.isNumber(cell.getStringCellValue())){
									ett.setSoNguoi(Integer.valueOf(cell.getStringCellValue()));
								}else{
									ett.setSoNguoi(0);
								}
						...
						case 16:
							if(typeImport==1){
								cell.setCellType(Cell.CELL_TYPE_STRING);
								if(Validator.isNotNull(cell.getStringCellValue())){
									try {
										 ett.setDateToGet(sdfM.parse(cell.getStringCellValue()));
										 ett.setDateToGetStr(cell.getStringCellValue());
									} catch (Exception e) {
										// TODO: handle exception
									}
...
//							}
						...
						case 17:
							cell.setCellType(Cell.CELL_TYPE_STRING);
							if(typeImport==1){
								ett.setGhiChu(cell.getStringCellValue());
							}
							break;
						}
