 ...
 * @generated
 */
public class KiemDemVienLocalServiceClp implements KiemDemVienLocalService {
	public KiemDemVienLocalServiceClp(
		...
		_methodName25 = "findKiemDemVien";

		_methodParameterTypes25 = new String[] {
				"java.lang.String", "java.lang.String"
			};

		_methodName26 = "getByTaiKhoan";
	...
	public vn.dtt.cmon.kiemdemvien.dao.model.KiemDemVien addKiemDemVien(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(kiemDemVien) });
		}
		catch (Throwable t) {
		...
		return (vn.dtt.cmon.kiemdemvien.dao.model.KiemDemVien)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<vn.dtt.cmon.kiemdemvien.dao.model.KiemDemVien> getKiemDemViens(
		...
		return (java.util.List<vn.dtt.cmon.kiemdemvien.dao.model.KiemDemVien>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public void addKiemDemVien(java.lang.String hoVaTen,
		...
		try {
			_invokableLocalService.invokeMethod(_methodName21,
				...
				new Object[] {
					ClpSerializer.translateInput(hoVaTen),
					
				ClpSerializer.translateInput(taiKhoan),
					
				ClpSerializer.translateInput(matKhau),
				...
				ClpSerializer.translateInput(chungMinhThu),
					
				ClpSerializer.translateInput(dienThoai),
	...
	public java.util.List<vn.dtt.cmon.kiemdemvien.dao.model.KiemDemVien> find(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName23,
					...
					new Object[] {
						ClpSerializer.translateInput(capHoatDong),
	...
	public vn.dtt.cmon.kiemdemvien.dao.model.KiemDemVien getByTaiKhoan(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName26,
					...
					new Object[] { ClpSerializer.translateInput(taiKhoan) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
