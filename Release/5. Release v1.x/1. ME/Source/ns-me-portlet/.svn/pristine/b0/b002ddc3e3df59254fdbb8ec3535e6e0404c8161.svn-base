...
/**
 * The persistence utility for the d a n h g i a v e s i n h x a service. This utility wraps {@link DANHGIAVESINHXAPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @see DANHGIAVESINHXAPersistenceImpl
 * @generated
 */
public class DANHGIAVESINHXAUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(DANHGIAVESINHXA danhgiavesinhxa) {
		getPersistence().clearCache(danhgiavesinhxa);
	}
	 ...
	 */
	public static List<DANHGIAVESINHXA> findWithDynamicQuery(
	 ...
	 */
	public static DANHGIAVESINHXA update(DANHGIAVESINHXA danhgiavesinhxa)
		throws SystemException {
		return getPersistence().update(danhgiavesinhxa);
	}
	...
	public static DANHGIAVESINHXA update(DANHGIAVESINHXA danhgiavesinhxa,
		...
		return getPersistence().update(danhgiavesinhxa, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(danhgiavesinhxa);
	}
	...
	*/
	public static void cacheResult(
		java.util.List<vn.dtt.sol.ns.danhgiavesinh.dao.model.DANHGIAVESINHXA> danhgiavesinhxas) {
		getPersistence().cacheResult(danhgiavesinhxas);
	}
	...
	*/
	public static vn.dtt.sol.ns.danhgiavesinh.dao.model.DANHGIAVESINHXA create(
		long id) {
	...
	*/
	public static vn.dtt.sol.ns.danhgiavesinh.dao.model.DANHGIAVESINHXA remove(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.sol.ns.danhgiavesinh.dao.NoSuchDANHGIAVESINHXAException {
		return getPersistence().remove(id);
	}

	public static vn.dtt.sol.ns.danhgiavesinh.dao.model.DANHGIAVESINHXA updateImpl(
		vn.dtt.sol.ns.danhgiavesinh.dao.model.DANHGIAVESINHXA danhgiavesinhxa)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(danhgiavesinhxa);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.danhgiavesinh.dao.model.DANHGIAVESINHXA findByPrimaryKey(
		long id)
		throws com.liferay.portal.kernel.exception.SystemException,
			vn.dtt.sol.ns.danhgiavesinh.dao.NoSuchDANHGIAVESINHXAException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dtt.sol.ns.danhgiavesinh.dao.model.DANHGIAVESINHXA fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dtt.sol.ns.danhgiavesinh.dao.model.DANHGIAVESINHXA> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static DANHGIAVESINHXAPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (DANHGIAVESINHXAPersistence)PortletBeanLocatorUtil.locate(vn.dtt.sol.ns.danhgiavesinh.dao.service.ClpSerializer.getServletContextName(),
					DANHGIAVESINHXAPersistence.class.getName());

			ReferenceRegistry.registerReference(DANHGIAVESINHXAUtil.class,
				"_persistence");
		}
	 ...
	 */
	public void setPersistence(DANHGIAVESINHXAPersistence persistence) {
	}

	private static DANHGIAVESINHXAPersistence _persistence;
}