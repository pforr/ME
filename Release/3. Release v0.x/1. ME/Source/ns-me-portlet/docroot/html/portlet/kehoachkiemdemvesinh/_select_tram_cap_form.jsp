...
<%
	...
	String dotLabel=":";
%>
<aui:select required="true" name="<%=KeHoachKiemDemNuocTerms.TRAM_CAP_NUOC_ID %>" id="<%=KeHoachKiemDemNuocTerms.TRAM_CAP_NUOC_ID %>" onChange="javascript:selectKiemDemVien();" label="<%= LanguageUtil.get(pageContext, \"tram-cap-nuoc\") +\" \"+requiredLabel+ dotLabel %>" showEmptyOption="<%= false %>">
