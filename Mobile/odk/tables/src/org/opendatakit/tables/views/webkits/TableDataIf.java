...
public class TableDataIf {
   ...
   /**
    * Get the text color of the given column for the given value.
    * Uses the color rules of the column. The default value is -16777216.
    * @param rowNumber the row to evaluate
    * @param elementPath the element path of the column
   ...
   /**
    * Get the text color of the status column.
    * Uses the color rules of the status column.
   ...
   /**
    * Get the text color of the row.
    * Uses the color rules of the table.
    * The default value is -16777216.
    * @param rowNumber the row to evaluate
    * @return String representation of the text color
    */
