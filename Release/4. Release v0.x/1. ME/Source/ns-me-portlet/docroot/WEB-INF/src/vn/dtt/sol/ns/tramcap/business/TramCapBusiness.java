...
public class TramCapBusiness {
	...
	public static List<TramCapNuoc> getTramCapNuocByTinhDauNoiNuoc(
			String maTinh, String namBaoCao) {
		List<TramCapNuoc> lst = new ArrayList<TramCapNuoc>();

		try {
			lst = TramCapNuocLocalServiceUtil.getTramCapNuocByTinhDauNoiNuoc(
					maTinh, namBaoCao);
		} catch (Exception e) {
			_log.error(e);
		}
	...
	public static List<TramCapNuoc> getTramCapNuocByThoiGianThuc(String maTinh, String namBaoCao, String danhgiakiemdem) {
		List<TramCapNuoc> lst = new ArrayList<TramCapNuoc>();
		try{
			lst = TramCapNuocLocalServiceUtil.getTramCapNuocByThoiGianThuc(maTinh,namBaoCao,danhgiakiemdem);
		}catch (Exception e) {
			_log.error(e);
		}
	...
	public static int countTramCapThoiGianThuc(String maTinh, String namBaoCao, String danhgiakiemdem, String tramCapNuocId) {
		int count = 0;

		try {
			count = TramCapNuocLocalServiceUtil.countTramCapThoiGianThuc(maTinh,namBaoCao,danhgiakiemdem,tramCapNuocId);
		} catch (Exception e) {
			_log.error(e);
		}
