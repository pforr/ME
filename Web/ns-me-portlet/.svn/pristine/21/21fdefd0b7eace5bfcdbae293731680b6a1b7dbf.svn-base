...
/**
 * Provides the local service interface for KeHoachNuocSach. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoa.vu
 * @see KeHoachNuocSachLocalServiceUtil
...
public interface KeHoachNuocSachLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link KeHoachNuocSachLocalServiceUtil} to access the ke hoach nuoc sach local service. Add custom service methods to {@link vn.dtt.sol.ns.tramcap.dao.service.impl.KeHoachNuocSachLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
