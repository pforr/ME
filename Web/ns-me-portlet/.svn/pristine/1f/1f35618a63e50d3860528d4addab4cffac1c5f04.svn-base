...
/**
 * Provides the local service interface for DM_THONXOM. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoa.vu
 * @see DM_THONXOMLocalServiceUtil
...
public interface DM_THONXOMLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DM_THONXOMLocalServiceUtil} to access the d m_ t h o n x o m local service. Add custom service methods to {@link vn.dtt.cmon.dm.dao.service.impl.DM_THONXOMLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
