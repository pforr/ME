...
//						dataItem = DataItemBusiness.getDATAITEMByTen(HoGiaDinhImportModel.getMaXa(),HoGiaDinhImportModel.getMaHuyen());
						...
						if(typeImport == 1){
							...
							if(Validator.isNotNull(HoGiaDinhImportModel.getDateToGetStr())){
								...
								ettImport.setThangXayDung(Validator.isNotNull(strSplit[0])?Integer.valueOf(strSplit[0]):0);
								ettImport.setNamXayDung(Validator.isNotNull(strSplit[1])?Integer.valueOf(strSplit[1]):0);
							}
