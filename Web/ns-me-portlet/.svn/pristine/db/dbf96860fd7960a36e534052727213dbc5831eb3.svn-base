...
/**
 * Provides the local service interface for NAVIGATION. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author khoa.vu
 * @see NAVIGATIONLocalServiceUtil
...
public interface NAVIGATIONLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link NAVIGATIONLocalServiceUtil} to access the n a v i g a t i o n local service. Add custom service methods to {@link vn.dtt.cmon.dm.dao.service.impl.NAVIGATIONLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
