...
import vn.dtt.sol.ns.vesinhmoitruong.dao.service.KeHoachKiemDemVeSinhLocalService;
...
/**
 * Provides the base implementation for the ke hoach kiem dem ve sinh local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.impl.KeHoachKiemDemVeSinhLocalServiceImpl}.
 * </p>
 *
 * @author BinhTH
 ...
 * @generated
 */
public abstract class KeHoachKiemDemVeSinhLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements KeHoachKiemDemVeSinhLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.KeHoachKiemDemVeSinhLocalServiceUtil} to access the ke hoach kiem dem ve sinh local service.
	 */
	...
	@Override
	public KeHoachKiemDemVeSinh addKeHoachKiemDemVeSinh(
		KeHoachKiemDemVeSinh keHoachKiemDemVeSinh) throws SystemException {
		keHoachKiemDemVeSinh.setNew(true);

		return keHoachKiemDemVeSinhPersistence.update(keHoachKiemDemVeSinh);
	}
	 ...
	 */
	@Override
	public KeHoachKiemDemVeSinh createKeHoachKiemDemVeSinh(int id) {
		return keHoachKiemDemVeSinhPersistence.create(id);
	}
	...
	@Override
	public KeHoachKiemDemVeSinh deleteKeHoachKiemDemVeSinh(int id)
		throws PortalException, SystemException {
		return keHoachKiemDemVeSinhPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public KeHoachKiemDemVeSinh deleteKeHoachKiemDemVeSinh(
		KeHoachKiemDemVeSinh keHoachKiemDemVeSinh) throws SystemException {
		return keHoachKiemDemVeSinhPersistence.remove(keHoachKiemDemVeSinh);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(KeHoachKiemDemVeSinh.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return keHoachKiemDemVeSinhPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return keHoachKiemDemVeSinhPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public KeHoachKiemDemVeSinh fetchKeHoachKiemDemVeSinh(int id)
		throws SystemException {
		return keHoachKiemDemVeSinhPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public KeHoachKiemDemVeSinh getKeHoachKiemDemVeSinh(int id)
		throws PortalException, SystemException {
		return keHoachKiemDemVeSinhPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return keHoachKiemDemVeSinhPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<KeHoachKiemDemVeSinh> getKeHoachKiemDemVeSinhs(int start,
		int end) throws SystemException {
		return keHoachKiemDemVeSinhPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getKeHoachKiemDemVeSinhsCount() throws SystemException {
		return keHoachKiemDemVeSinhPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public KeHoachKiemDemVeSinh updateKeHoachKiemDemVeSinh(
		KeHoachKiemDemVeSinh keHoachKiemDemVeSinh) throws SystemException {
		return keHoachKiemDemVeSinhPersistence.update(keHoachKiemDemVeSinh);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.sol.ns.vesinhmoitruong.dao.model.KeHoachKiemDemVeSinh",
			keHoachKiemDemVeSinhLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = keHoachKiemDemVeSinhPersistence.getDataSource();
	...
	private KeHoachKiemDemVeSinhLocalServiceClpInvoker _clpInvoker = new KeHoachKiemDemVeSinhLocalServiceClpInvoker();
}