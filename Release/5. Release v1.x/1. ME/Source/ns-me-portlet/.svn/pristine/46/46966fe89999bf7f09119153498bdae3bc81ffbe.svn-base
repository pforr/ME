...
import vn.dtt.cmon.dm.dao.model.DM_THONXOMClp;
...
public class ClpSerializer {
	...
	public static Object translateInput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(DM_THONXOMClp.class.getName())) {
			return translateInputDM_THONXOM(oldModel);
		}
	...
	public static Object translateInputDM_THONXOM(BaseModel<?> oldModel) {
		DM_THONXOMClp oldClpModel = (DM_THONXOMClp)oldModel;

		BaseModel<?> newModel = oldClpModel.getDM_THONXOMRemoteModel();
	...
	public static Object translateOutput(BaseModel<?> oldModel) {
		...
		if (oldModelClassName.equals(
					"vn.dtt.cmon.dm.dao.model.impl.DM_THONXOMImpl")) {
			return translateOutputDM_THONXOM(oldModel);
		}
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals("vn.dtt.cmon.dm.dao.NoSuchDM_THONXOMException")) {
			return new vn.dtt.cmon.dm.dao.NoSuchDM_THONXOMException();
		}
	...
	public static Object translateOutputDM_THONXOM(BaseModel<?> oldModel) {
		DM_THONXOMClp newModel = new DM_THONXOMClp();

		newModel.setModelAttributes(oldModel.getModelAttributes());

		newModel.setDM_THONXOMRemoteModel(oldModel);
