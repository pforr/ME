...
import vn.dtt.sol.ns.vesinhmoitruong.dao.service.keHoachVeSinhXaNewLocalService;
...
/**
 * Provides the base implementation for the ke hoach ve sinh xa new local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.impl.keHoachVeSinhXaNewLocalServiceImpl}.
 * </p>
 *
 * @author BinhTH
 ...
 * @generated
 */
public abstract class keHoachVeSinhXaNewLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements keHoachVeSinhXaNewLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.sol.ns.vesinhmoitruong.dao.service.keHoachVeSinhXaNewLocalServiceUtil} to access the ke hoach ve sinh xa new local service.
	 */
	...
	@Override
	public keHoachVeSinhXaNew addkeHoachVeSinhXaNew(
		keHoachVeSinhXaNew keHoachVeSinhXaNew) throws SystemException {
		keHoachVeSinhXaNew.setNew(true);

		return keHoachVeSinhXaNewPersistence.update(keHoachVeSinhXaNew);
	}
	 ...
	 */
	@Override
	public keHoachVeSinhXaNew createkeHoachVeSinhXaNew(int id) {
		return keHoachVeSinhXaNewPersistence.create(id);
	}
	...
	@Override
	public keHoachVeSinhXaNew deletekeHoachVeSinhXaNew(int id)
		throws PortalException, SystemException {
		return keHoachVeSinhXaNewPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public keHoachVeSinhXaNew deletekeHoachVeSinhXaNew(
		keHoachVeSinhXaNew keHoachVeSinhXaNew) throws SystemException {
		return keHoachVeSinhXaNewPersistence.remove(keHoachVeSinhXaNew);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(keHoachVeSinhXaNew.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return keHoachVeSinhXaNewPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return keHoachVeSinhXaNewPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public keHoachVeSinhXaNew fetchkeHoachVeSinhXaNew(int id)
		throws SystemException {
		return keHoachVeSinhXaNewPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public keHoachVeSinhXaNew getkeHoachVeSinhXaNew(int id)
		throws PortalException, SystemException {
		return keHoachVeSinhXaNewPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return keHoachVeSinhXaNewPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<keHoachVeSinhXaNew> getkeHoachVeSinhXaNews(int start, int end)
		throws SystemException {
		return keHoachVeSinhXaNewPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getkeHoachVeSinhXaNewsCount() throws SystemException {
		return keHoachVeSinhXaNewPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public keHoachVeSinhXaNew updatekeHoachVeSinhXaNew(
		keHoachVeSinhXaNew keHoachVeSinhXaNew) throws SystemException {
		return keHoachVeSinhXaNewPersistence.update(keHoachVeSinhXaNew);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.sol.ns.vesinhmoitruong.dao.model.keHoachVeSinhXaNew",
			keHoachVeSinhXaNewLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = keHoachVeSinhXaNewPersistence.getDataSource();
	...
	private keHoachVeSinhXaNewLocalServiceClpInvoker _clpInvoker = new keHoachVeSinhXaNewLocalServiceClpInvoker();
}