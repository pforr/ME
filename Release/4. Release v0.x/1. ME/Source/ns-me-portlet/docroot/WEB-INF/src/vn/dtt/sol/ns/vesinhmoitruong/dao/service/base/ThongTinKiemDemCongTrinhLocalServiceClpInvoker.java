...
public class ThongTinKiemDemCongTrinhLocalServiceClpInvoker {
	public ThongTinKiemDemCongTrinhLocalServiceClpInvoker() {
		...
		_methodName80 = "getListThongTinKiemDemCongTrinhByCTID";

		_methodParameterTypes80 = new String[] { "int", "int", "int" };

		_methodName81 = "getListThongTinKiemDemCongTrinhByGDID";

		_methodParameterTypes81 = new String[] { "int", "int", "int" };

		_methodName82 = "getCountCongTrinhBykeHoachId";

		_methodParameterTypes82 = new String[] { "int", "int" };

		_methodName83 = "getCountCongTrinhBykeHoachIdDanhGiaKiemDem";

		_methodParameterTypes83 = new String[] { "int", "int" };

		_methodName84 = "getSumCtBykeHoachKiemDemVsId";
