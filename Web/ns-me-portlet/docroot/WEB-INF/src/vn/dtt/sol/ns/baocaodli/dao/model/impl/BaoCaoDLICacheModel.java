...
public class BaoCaoDLICacheModel implements CacheModel<BaoCaoDLI>,
	...
	public BaoCaoDLI toEntityModel() {
		...
		if (keHoachNam == null) {
			baoCaoDLIImpl.setKeHoachNam(StringPool.BLANK);
		}
		else {
			baoCaoDLIImpl.setKeHoachNam(keHoachNam);
		}

		if (ngayPheDuyet == Long.MIN_VALUE) {
			baoCaoDLIImpl.setNgayPheDuyet(null);
		}
		else {
			baoCaoDLIImpl.setNgayPheDuyet(new Date(ngayPheDuyet));
		}

		if (baoCaoChuongTrinh == null) {
			baoCaoDLIImpl.setBaoCaoChuongTrinh(StringPool.BLANK);
		}
		else {
			baoCaoDLIImpl.setBaoCaoChuongTrinh(baoCaoChuongTrinh);
		}

		if (ngayDang == Long.MIN_VALUE) {
			baoCaoDLIImpl.setNgayDang(null);
		}
		else {
			baoCaoDLIImpl.setNgayDang(new Date(ngayDang));
		}
	...
	public void readExternal(ObjectInput objectInput) throws IOException {
		...
		keHoachNam = objectInput.readUTF();
		ngayPheDuyet = objectInput.readLong();
	...
	public void writeExternal(ObjectOutput objectOutput)
		...
		if (keHoachNam == null) {
			...
			objectOutput.writeUTF(keHoachNam);
		}

		objectOutput.writeLong(ngayPheDuyet);
	...
	public String keHoachNam;
	public long ngayPheDuyet;
