...
import vn.dtt.sol.ns.tramcap.dao.service.THONGTINKIEMDEMNUOCLocalService;
...
/**
 * Provides the base implementation for the t h o n g t i n k i e m d e m n u o c local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.sol.ns.tramcap.dao.service.impl.THONGTINKIEMDEMNUOCLocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 ...
 * @generated
 */
public abstract class THONGTINKIEMDEMNUOCLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements THONGTINKIEMDEMNUOCLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.sol.ns.tramcap.dao.service.THONGTINKIEMDEMNUOCLocalServiceUtil} to access the t h o n g t i n k i e m d e m n u o c local service.
	 */
	...
	@Override
	public THONGTINKIEMDEMNUOC addTHONGTINKIEMDEMNUOC(
		THONGTINKIEMDEMNUOC thongtinkiemdemnuoc) throws SystemException {
		thongtinkiemdemnuoc.setNew(true);

		return thongtinkiemdemnuocPersistence.update(thongtinkiemdemnuoc);
	}
	 ...
	 */
	@Override
	public THONGTINKIEMDEMNUOC createTHONGTINKIEMDEMNUOC(long id) {
		return thongtinkiemdemnuocPersistence.create(id);
	}
	...
	@Override
	public THONGTINKIEMDEMNUOC deleteTHONGTINKIEMDEMNUOC(long id)
		throws PortalException, SystemException {
		return thongtinkiemdemnuocPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public THONGTINKIEMDEMNUOC deleteTHONGTINKIEMDEMNUOC(
		THONGTINKIEMDEMNUOC thongtinkiemdemnuoc) throws SystemException {
		return thongtinkiemdemnuocPersistence.remove(thongtinkiemdemnuoc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(THONGTINKIEMDEMNUOC.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return thongtinkiemdemnuocPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return thongtinkiemdemnuocPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public THONGTINKIEMDEMNUOC fetchTHONGTINKIEMDEMNUOC(long id)
		throws SystemException {
		return thongtinkiemdemnuocPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public THONGTINKIEMDEMNUOC getTHONGTINKIEMDEMNUOC(long id)
		throws PortalException, SystemException {
		return thongtinkiemdemnuocPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return thongtinkiemdemnuocPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<THONGTINKIEMDEMNUOC> getTHONGTINKIEMDEMNUOCs(int start, int end)
		throws SystemException {
		return thongtinkiemdemnuocPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getTHONGTINKIEMDEMNUOCsCount() throws SystemException {
		return thongtinkiemdemnuocPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public THONGTINKIEMDEMNUOC updateTHONGTINKIEMDEMNUOC(
		THONGTINKIEMDEMNUOC thongtinkiemdemnuoc) throws SystemException {
		return thongtinkiemdemnuocPersistence.update(thongtinkiemdemnuoc);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.sol.ns.tramcap.dao.model.THONGTINKIEMDEMNUOC",
			thongtinkiemdemnuocLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = thongtinkiemdemnuocPersistence.getDataSource();
	...
	private THONGTINKIEMDEMNUOCLocalServiceClpInvoker _clpInvoker = new THONGTINKIEMDEMNUOCLocalServiceClpInvoker();
}