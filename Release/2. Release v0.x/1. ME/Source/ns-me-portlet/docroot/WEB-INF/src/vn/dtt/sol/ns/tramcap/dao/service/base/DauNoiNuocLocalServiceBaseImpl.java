...
import vn.dtt.sol.ns.tramcap.dao.service.DauNoiNuocLocalService;
...
/**
 * Provides the base implementation for the dau noi nuoc local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.dtt.sol.ns.tramcap.dao.service.impl.DauNoiNuocLocalServiceImpl}.
 * </p>
 *
 * @author khoa.vu
 ...
 * @generated
 */
public abstract class DauNoiNuocLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements DauNoiNuocLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.dtt.sol.ns.tramcap.dao.service.DauNoiNuocLocalServiceUtil} to access the dau noi nuoc local service.
	 */
	...
	@Override
	public DauNoiNuoc addDauNoiNuoc(DauNoiNuoc dauNoiNuoc)
		throws SystemException {
		dauNoiNuoc.setNew(true);

		return dauNoiNuocPersistence.update(dauNoiNuoc);
	}
	 ...
	 */
	@Override
	public DauNoiNuoc createDauNoiNuoc(long id) {
		return dauNoiNuocPersistence.create(id);
	}
	...
	@Override
	public DauNoiNuoc deleteDauNoiNuoc(long id)
		throws PortalException, SystemException {
		return dauNoiNuocPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DauNoiNuoc deleteDauNoiNuoc(DauNoiNuoc dauNoiNuoc)
		throws SystemException {
		return dauNoiNuocPersistence.remove(dauNoiNuoc);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(DauNoiNuoc.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dauNoiNuocPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dauNoiNuocPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dauNoiNuocPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public DauNoiNuoc fetchDauNoiNuoc(long id) throws SystemException {
		return dauNoiNuocPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DauNoiNuoc getDauNoiNuoc(long id)
		throws PortalException, SystemException {
		return dauNoiNuocPersistence.findByPrimaryKey(id);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dauNoiNuocPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DauNoiNuoc> getDauNoiNuocs(int start, int end)
		throws SystemException {
		return dauNoiNuocPersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getDauNoiNuocsCount() throws SystemException {
		return dauNoiNuocPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DauNoiNuoc updateDauNoiNuoc(DauNoiNuoc dauNoiNuoc)
		throws SystemException {
		return dauNoiNuocPersistence.update(dauNoiNuoc);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("vn.dtt.sol.ns.tramcap.dao.model.DauNoiNuoc",
			dauNoiNuocLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dauNoiNuocPersistence.getDataSource();
	...
	private DauNoiNuocLocalServiceClpInvoker _clpInvoker = new DauNoiNuocLocalServiceClpInvoker();
}