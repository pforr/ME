...
/**
 * Provides the remote service interface for BaoCaoDLITongHop. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author HuyMQ
 * @see BaoCaoDLITongHopServiceUtil
...
public interface BaoCaoDLITongHopService extends BaseService, InvokableService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BaoCaoDLITongHopServiceUtil} to access the bao cao d l i tong hop remote service. Add custom service methods to {@link vn.dtt.sol.ns.baocaodli.dao.service.impl.BaoCaoDLITongHopServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
