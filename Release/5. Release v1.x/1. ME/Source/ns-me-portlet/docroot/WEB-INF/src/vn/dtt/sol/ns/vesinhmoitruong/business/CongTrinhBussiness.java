...
public class CongTrinhBussiness {
	...
	public static List<VeSinhCongTrinh> getVeSinhCongTrinhJoinThongTinKiemDemCT(String maTinh,String maHuyen, String maXa, String loaiNhaTieuId, String loaiCongTrinh, String trangThai, String namBaoCao,String daketthucdieutra, String danhgiakiemdem){
		List<VeSinhCongTrinh> lst = new ArrayList<VeSinhCongTrinh>();
		
		try{
			lst = VeSinhCongTrinhLocalServiceUtil.getVeSinhCongTrinhJoinThongTinKiemDemCT( maTinh, maHuyen,  maXa,  loaiNhaTieuId,  loaiCongTrinh,  trangThai,  namBaoCao, daketthucdieutra, danhgiakiemdem);
		}catch(Exception e){
			_log.error(e);
		}
		return lst;
