...
public class BaoCaoDLIWrapper implements BaoCaoDLI, ModelWrapper<BaoCaoDLI> {
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("keHoachNam", getKeHoachNam());
		attributes.put("ngayPheDuyet", getNgayPheDuyet());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String keHoachNam = (String)attributes.get("keHoachNam");

		if (keHoachNam != null) {
			setKeHoachNam(keHoachNam);
		}

		Date ngayPheDuyet = (Date)attributes.get("ngayPheDuyet");

		if (ngayPheDuyet != null) {
			setNgayPheDuyet(ngayPheDuyet);
		}
	...
	*/
	...
	/**
	* Returns the ke hoach nam of this bao cao d l i.
	*
	* @return the ke hoach nam of this bao cao d l i
	*/
	@Override
	public java.lang.String getKeHoachNam() {
		return _baoCaoDLI.getKeHoachNam();
	}

	/**
	* Sets the ke hoach nam of this bao cao d l i.
	*
	* @param keHoachNam the ke hoach nam of this bao cao d l i
	*/
	@Override
	public void setKeHoachNam(java.lang.String keHoachNam) {
		_baoCaoDLI.setKeHoachNam(keHoachNam);
	}

	/**
	* Returns the ngay phe duyet of this bao cao d l i.
	*
	* @return the ngay phe duyet of this bao cao d l i
	*/
	@Override
	public java.util.Date getNgayPheDuyet() {
		return _baoCaoDLI.getNgayPheDuyet();
	}

	/**
	* Sets the ngay phe duyet of this bao cao d l i.
	*
	* @param ngayPheDuyet the ngay phe duyet of this bao cao d l i
	*/
	@Override
	public void setNgayPheDuyet(java.util.Date ngayPheDuyet) {
		_baoCaoDLI.setNgayPheDuyet(ngayPheDuyet);
	}

	/**
	* Returns the bao cao chuong trinh of this bao cao d l i.
	*
	* @return the bao cao chuong trinh of this bao cao d l i
	*/
	@Override
	public java.lang.String getBaoCaoChuongTrinh() {
		return _baoCaoDLI.getBaoCaoChuongTrinh();
	}

	/**
	* Sets the bao cao chuong trinh of this bao cao d l i.
	*
	* @param baoCaoChuongTrinh the bao cao chuong trinh of this bao cao d l i
	*/
	@Override
	public void setBaoCaoChuongTrinh(java.lang.String baoCaoChuongTrinh) {
		_baoCaoDLI.setBaoCaoChuongTrinh(baoCaoChuongTrinh);
	}

	/**
	* Returns the ngay dang of this bao cao d l i.
	*
	* @return the ngay dang of this bao cao d l i
	*/
	@Override
	public java.util.Date getNgayDang() {
		return _baoCaoDLI.getNgayDang();
	}

	/**
	* Sets the ngay dang of this bao cao d l i.
	*
	* @param ngayDang the ngay dang of this bao cao d l i
	*/
	@Override
	public void setNgayDang(java.util.Date ngayDang) {
		_baoCaoDLI.setNgayDang(ngayDang);
	}
	...
	@Override
	public com.liferay.portal.model.CacheModel<BaoCaoDLI> toCacheModel() {
	...
	@Override
	public BaoCaoDLI toUnescapedModel() {
